...
/**
 *  Graphics implementation file.
 *
 *  Provides drawing output by use of the 'ncurses' library, which abstracts a lot of the actual interaction with the
 *  terminal state, e.g. cursor positioning and character formatting.
 */
